...
** Desc:  Header file for the dnadb object made in dnadb.cpp
...
class DnaDb{
    ...
    ******************************************/
    ...
    bool checkDna(DNA dna); //helper function to check duplicate dna
    bool checkKey(string key); //helper function to check coliding keys
    void RehashTable(); //helper function for rehashing once it triggered
